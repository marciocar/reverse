...
- [`relatorio-auditoria-ia.md`](./governance/templates/comites/2-ia/relatorio-auditoria-ia.md) - Auditoria + Serasa Due Diligence (~550 linhas)
...
| # | Requisito Serasa | Framework | Documento | Status |
|---|------------------|-----------|-----------|--------|
