...
> ✅ **Responde:** Serasa Experian Due Diligence Item 9.12 - "Mapa detalhado dos processos de tratamento de dados pessoais"
...
| **CPF** | PII | Identificação, KYC | Execução de contrato + Obrigação legal | Ativo + 7 anos (BACEN) | Registradoras, Serasa (consulta) |
...
├── Serasa Experian (consulta de crédito) - com consentimento
...
| **Serasa Experian** | CPF (consulta apenas) | Análise de crédito | Consentimento | ✅ Sim | Brasil |
