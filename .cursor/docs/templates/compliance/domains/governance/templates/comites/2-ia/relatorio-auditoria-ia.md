...
> **Objetivo:** Avaliar conformidade, performance, fairness e segurança de modelo(s) de IA em produção, fornecendo evidências para governança e compliance regulatório (LGPD, (Cliente Enterprise - {{CUSTOMER_NAME}}) Due Diligence).
...
- (Cliente Enterprise - {{CUSTOMER_NAME}}) (evidências de compliance)
...
4. ✅ **Conformidade Regulatória**
   ...
   - (Cliente Enterprise - {{CUSTOMER_NAME}}) Due Diligence (Seção VIII - IA)
...
### 7.1 Checklist (Cliente Enterprise - {{CUSTOMER_NAME}})
...
**Evidências Disponíveis para Auditoria (Cliente Enterprise - {{CUSTOMER_NAME}}):**
