...
> ✅ **Responde:** Due Diligence de Cliente Enterprise Requisitos #4 e #5 - "Evidências de Testes de BCM (certificado e procedimentos)" + "Comprovação e programação de treinamentos"
...
| **Notification** | Interna | Clientes enterprise ((Cliente Enterprise - {{CUSTOMER_NAME}})) |

#### Test Procedure (High-Level)

1. **Pre-Notification (1 semana antes):**
   - Email para todos clientes enterprise (incluindo (Cliente Enterprise - {{CUSTOMER_NAME}}))
...
| 2025-03-10 | Regional Outage | Validar lista de contatos (Cliente Enterprise - {{CUSTOMER_NAME}}) | 1 criado, 100% done |
...
- SLAs com clientes (ex: (Cliente Enterprise - {{CUSTOMER_NAME}}))
...
- Atualização de contatos (ex: (Cliente Enterprise - {{CUSTOMER_NAME}}))
