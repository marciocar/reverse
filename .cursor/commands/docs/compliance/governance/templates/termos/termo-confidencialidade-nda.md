...
### **PARTE RECEPTORA (Colaborador/Terceiro)**

**Nome Completo**: ___________________________________________________________

**CPF/CNPJ**: ___________________________  **RG**: _________________________

**Endereço Completo**: _______________________________________________________

______________________________________________________________________________

**Cargo/Função** (se colaborador): ___________________________________________

**Empresa** (se terceiro): ___________________________________________________

Doravante denominada **"RECEPTORA"**.
...
-  Dados financeiros (faturamento, transações, recebíveis)
-  Informações contratuais (prazos, valores, condições)
-  Histórico de relacionamento comercial
-  Informações pessoais sensíveis (LGPD)

#### **1.1.2 Informações Estratégicas e Comerciais**
-  Planos de negócio, estratégias comerciais
-  Metas de vendas, projeções financeiras
-  Modelos de precificação, margens
-  Parcerias em negociação
-  Planos de expansão, novos produtos
-  Análises de mercado e concorrência

#### **1.1.3 Informações Técnicas e Tecnológicas**
-  Código-fonte, algoritmos, arquitetura de sistemas
-  APIs, integrações, documentação técnica
-  Bancos de dados, estruturas de dados
-  Diagramas, fluxogramas, especificações
-  Propriedade intelectual (patentes, marcas, copyrights)
-  Processos de desenvolvimento, metodologias

#### **1.1.4 Informações Operacionais e Financeiras**
-  Demonstrações financeiras (balanço, DRE, fluxo de caixa)
-  Orçamentos, custos, despesas
-  Contratos com fornecedores, valores pagos
-  Estrutura de custos, break-even
-  Projeções de receita, análises de ROI

#### **1.1.5 Informações de Pessoas e Organização**
-  Estrutura organizacional, organograma
-  Dados de colaboradores (salários, benefícios, desempenho)
-  Contratos de trabalho, políticas de RH
-  Planos de sucessão, talentos-chave

#### **1.1.6 Outras Informações**
-  Qualquer informação marcada como "Confidencial", "Restrita" ou "Interna"
-  Informações verbais identificadas como confidenciais
-  Informações que, por sua natureza, devam ser tratadas como confidenciais

### 1.2 Exceções (Informações NÃO Confidenciais)
...
✅ **Adotar medidas de segurança** para proteger as Informações Confidenciais, incluindo:
- Armazenamento seguro (físico e digital)
- Controle de acesso (apenas pessoas autorizadas)
- Criptografia quando aplicável
- Não copiar/imprimir sem necessidade
- Não usar dispositivos pessoais não autorizados

### 2.4 Compartilhamento Limitado (Need-to-Know)

✅ **Compartilhar** Informações Confidenciais **somente** com:
- Colaboradores diretos que necessitem conhecê-las (princípio do need-to-know)
- Desde que tais pessoas também estejam vinculadas por termo de confidencialidade
...
✅ **Destruir permanentemente** todas as cópias digitais (e-mails, arquivos, backups pessoais) das Informações Confidenciais.

✅ **Confirmar por escrito** a devolução/destruição completa.

❌ **NÃO reter** cópias, backups ou qualquer forma de registro das Informações Confidenciais.
...
⚠️ **IMPORTANTE**: As obrigações de confidencialidade **permanecem vigentes** mesmo após:
- Demissão ou pedido de demissão
- Término de contrato de prestação de serviços
- Fim de parceria comercial
- Qualquer outra forma de término do vínculo

---

## 6. CONSEQUÊNCIAS DE VIOLAÇÃO

### 6.1 Sanções Administrativas (se colaborador)

A violação deste NDA pode resultar em:
- ⚠️ Advertência escrita
- ⚠️ Suspensão
- ⚠️ **Demissão por justa causa** (CLT, Art. 482, alíneas "c" e "g")

### 6.2 Responsabilização Civil
...
Dependendo da gravidade, a violação pode configurar crimes:
- ⚖️ **Violação de segredo profissional** (Código Penal, Art. 154)
- ⚖️ **Concorrência desleal** (Lei 9.279/1996)
- ⚖️ **Violação de dados** (LGPD, Art. 154-A do CP)
...
Este NDA é independente de qualquer outro contrato firmado entre as partes (contrato de trabalho, prestação de serviços, parceria).

### 7.2 Alterações

Alterações a este NDA só serão válidas se feitas por escrito e assinadas por ambas as partes.
...
A não exigência imediata de cumprimento de qualquer cláusula não constitui renúncia ao direito de fazê-lo posteriormente.

### 7.5 Nulidade Parcial

Se qualquer cláusula for considerada inválida, as demais permanecem em vigor.

### 7.6 Foro

Fica eleito o foro da comarca de [A DEFINIR - Cidade da sede] para dirimir quaisquer controvérsias.
...
Declaro que:
1. Li e compreendi integralmente este Termo de Confidencialidade
2. Estou ciente de todas as obrigações e responsabilidades
3. Comprometo-me a cumprir rigorosamente todas as cláusulas
4. Entendo as consequências legais em caso de violação
...
**Nome**: __________________________  **Cargo**: CEO / Diretor
...
**_____________________________________________**  
**Nome**: _________________________  **CPF**: _________________________________
...
|--------|------|----------|-------------|
| 1.0 | 2025-01-06 | Versão inicial | Compliance / Jurídico |
