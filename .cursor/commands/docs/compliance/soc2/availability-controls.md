...
> ✅ **Responde:** Serasa Experian Due Diligence Requisito #8 - "SLAs + Documentação de disponibilidade contratual"
...
### SLA Clientes Enterprise (Serasa Experian)
...
**SLA Report:**
- Enviado mensalmente para contato Serasa (até dia 5 do mês seguinte)
